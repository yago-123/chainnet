...
func TestReverseIterator(t *testing.T) {
	...
	coinbaseTx := kernel.NewCoinbaseTransaction("address-1", InitialCoinbaseReward, 0)
	...
	coinbaseTx2 := kernel.NewCoinbaseTransaction("address-2", InitialCoinbaseReward, 0)
	...
	coinbaseTx3 := kernel.NewCoinbaseTransaction("address-3", InitialCoinbaseReward, 0)
