...
func TestHValidator_validateNumberOfCoinbaseTxs(t *testing.T) {
	...
	hvalidator := NewHeavyValidator(NewLightValidator(&mockHash.FakeHashing{}), expl.NewExplorer(&mockStorage.MockStorage{}), &mockSign.MockSign{}, &mockHash.FakeHashing{})
...
func TestHValidator_validateNoDoubleSpendingInsideBlock(t *testing.T) {
	...
	hvalidator := NewHeavyValidator(NewLightValidator(fakeHashing), expl.NewExplorer(&mockStorage.MockStorage{}), &mockSign.MockSign{}, fakeHashing)
...
func TestHValidator_validatePreviousBlockMatchCurrentLatest(t *testing.T) {
	...
	fakeHashing := &mockHash.FakeHashing{}
	hvalidator := NewHeavyValidator(NewLightValidator(fakeHashing), expl.NewExplorer(mockStore), &mockSign.MockSign{}, fakeHashing)
